...
#define CONFIGURE_ARGS " '--build=i686-w64-mingw32' '--host=i686-w64-mingw32' '--target=i686-w64-mingw32' '--prefix=/mingw32' '--enable-thread-safety' '--enable-integer-datetimes' '--enable-nls' '--disable-rpath' '--with-ldap' '--with-libxml' '--with-libxslt' '--with-lz4' '--with-ssl=openssl' '--with-python' '--with-zstd' '--without-perl' '--with-tcl' '--with-tclconfig=/mingw32/lib' 'build_alias=i686-w64-mingw32' 'host_alias=i686-w64-mingw32' 'target_alias=i686-w64-mingw32' 'CC=gcc' 'CFLAGS=-march=pentium4 -mtune=generic -O2 -pipe -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong' 'LDFLAGS=-pipe -Wl,--no-seh -Wl,--large-address-aware' 'CPPFLAGS=-D__USE_MINGW_ANSI_STDIO=1' 'CXX=g++' 'CXXFLAGS=-march=pentium4 -mtune=generic -O2 -pipe' 'PKG_CONFIG_PATH=/mingw32/lib/pkgconfig:/mingw32/share/pkgconfig' 'PYTHON=/mingw32/bin/python'"
...
#define PG_VERSION_STR "PostgreSQL 16.1 on i686-w64-mingw32, compiled by gcc.exe (Rev2, Built by MSYS2 project) 13.2.0, 32-bit"
